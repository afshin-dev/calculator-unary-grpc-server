...
type CalculateClient interface {
	Execute(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateResponse, error)
}
...
func (c *calculateClient) Execute(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateResponse, error) {
	out := new(CalculateResponse)
	err := c.cc.Invoke(ctx, "/calculator.Calculate/execute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculateServer interface {
	Execute(context.Context, *CalculateRequest) (*CalculateResponse, error)
...
func (UnimplementedCalculateServer) Execute(context.Context, *CalculateRequest) (*CalculateResponse, error) {
...
func _Calculate_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CalculateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculateServer).Execute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.Calculate/execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculateServer).Execute(ctx, req.(*CalculateRequest))
	}
...
var Calculate_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "execute",
			Handler:    _Calculate_Execute_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "PATH/protod/calculator.proto",
}
